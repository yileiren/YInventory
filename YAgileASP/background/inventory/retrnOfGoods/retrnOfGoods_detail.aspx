<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retrnOfGoods_detail.aspx.cs" Inherits="YAgileASP.background.inventory.retrnOfGoods.retrnOfGoods_detail" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        function addDetail()
        {
            window.parent.popupsWindow("#popups", "选择货物", 800, 500, "inventory/retrnOfGoods/chouseGoods.aspx?masterId=<%=this.inv.id %>" + "&warehouseId=" + <%=this.inv.warehouse.id %>, "icon-ok", true, true);
        }
        ...
        */
        function editDetail()
        {
            ...
            {
                alert("请选中要编辑的退货单明细，一次只能选择一个！");
                return;
            }

            window.parent.popupsWindow("#popups", "修改明细", 600, 255, "inventory/retrnOfGoods/retrnOfGoods_detail_edit.aspx?masterId=" + $("#hidPutInStorageId").val() + "&id=" + $("input:checked[type='checkbox'][name='chkDetail']").eq(0).val(), "icon-edit", true, true);
        }
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div region="north" border="true" style="height:28px;background-color:#EEF5FD">
        <div style="width:250px;margin-left:auto;margin-top:0px;margin-right:0px">
            ...
            <a href="retrnOfGoods_list.aspx" class="easyui-linkbutton" iconCls="icon-back" plain="true">返回</a>
        </div>
