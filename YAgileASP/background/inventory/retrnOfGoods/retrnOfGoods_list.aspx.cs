...
{
    public partial class retrnOfGoods_list : System.Web.UI.Page
    {
        ...
        public void bindInvs()
        {
            try
            {
                ...
                {
                    //获取入库单列表
                    List<InventoryMasterInfo> invs = invOper.getRetrnOfGoods(this.txtNumber.Value,
            ...
            try
            {
                ...
                if (invIds.Length > 0)
                {
                    ...
                    if (oper != null)
                    {
                        ...
                        if (oper.deleteRetrnOfGoods(invIntIds))
                        {
                            this.Response.Redirect("retrnOfGoods_list.aspx");
