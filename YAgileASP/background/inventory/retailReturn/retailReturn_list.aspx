<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailReturn_list.aspx.cs" Inherits="YAgileASP.background.inventory.retailReturn.retailReturn_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        function addRetrnToStorage()
        {
            window.parent.popupsWindow("#popups", "新增退库单", 600, 165, "inventory/retailReturn/retailReturn_edit.aspx", "icon-add", true, true);
        }
        ...
        */
        function editRetrnToStorage()
        {
            ...
            window.parent.popupsWindow("#popups", "修改退库单", 600, 165, "inventory/retailReturn/retailReturn_edit.aspx?id=" + $("input:checked[type='checkbox'][name='chkInv']").eq(0).val(), "icon-edit", true, true);
        }
        ...
        */
        function deleteRetrnToStorage()
        {
            //判断选中
            if ($("input:checked[type='checkbox'][name='chkInv']").length > 0)
            {
                return confirm("确认要删除选中的退库单？");
            }
            else
            {
                alert("请选中要删除的退库单！");
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div region="north" border="true" style="height:28px;background-color:#EEF5FD">
        <div style="width:200px;margin-left:auto;margin-top:0px;margin-right:0px">
            <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:addRetrnToStorage();">新增</a>
            <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editRetrnToStorage();">修改</a>
            <a href="#" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="javascript:return deleteRetrnToStorage();" runat="server" onserverclick="butDeleteItems_Click">删除</a>
        </div>
    </div>
            ...
            <table class="admintable" style="width:100%;">
                ...
                <tr style="height:30px">
                    ...
                    <td class="adminth_s2" style="text-align:center">
                        <a id="A1" href="#" class="easyui-linkbutton" iconCls="icon-search" runat="server" onserverclick="butSearch_Click">筛选</a>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div style="width:1120px;margin:0px auto">
                ...
                <ItemTemplate>
                    <tr style="width:100%;height:30px">
                        ...
                        <td class="admincls0" style="text-align:center">
                            <a href="retrnToStorage_detail.aspx?id=<%#Eval("id")%>" class="easyui-linkbutton" iconCls="icon-detail" plain="true" onclick="">明细</a>
                        </td>
                    </tr>
                </ItemTemplate>
