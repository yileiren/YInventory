...
{
    public partial class retailReturn_edit : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (oper != null)
                {
                    if (string.IsNullOrEmpty(this.hidPutInStorageId.Value))
                    {
                        ...
                        {
                            YMessageBox.showAndResponseScript(this, "保存成功！", "window.parent.closePopupsWindow('#popups');", "window.parent.menuButtonOnClick('零售退货','icon-retailReturn','inventory/retailReturn/retailReturn_list.aspx')");
                        }
                        else
                        {
