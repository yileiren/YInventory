<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retrnToStorage_list.aspx.cs" Inherits="YAgileASP.background.inventory.retrnToStorage.retrnToStorage_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        ...
        {
            window.parent.popupsWindow("#popups", "新增退库单", 600, 165, "inventory/retrnToStorage/retrnToStorage_edit.aspx", "icon-add", true, true);
        }
        ...
        */
        function editRetrnToStorage()
        {
            ...
            window.parent.popupsWindow("#popups", "修改退库单", 600, 165, "inventory/retrnToStorage/retrnToStorage_edit.aspx?id=" + $("input:checked[type='checkbox'][name='chkInv']").eq(0).val(), "icon-edit", true, true);
        }
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div region="north" border="true" style="height:28px;background-color:#EEF5FD">
        <div style="width:200px;margin-left:auto;margin-top:0px;margin-right:0px">
            ...
            <a id="A1" href="#" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="javascript:return deleteRetrnToStorage();" runat="server" onserverclick="butDeleteItems_Click">删除</a>
        </div>
    </div>
