<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retrnToStorage_detail_edit.aspx.cs" Inherits="YAgileASP.background.inventory.retrnToStorage.retrnToStorage_detail_edit" %>
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD"">
        ...
        <table class="admintable" style="width:100%;">
            ...
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">退库数量：</th>
                <td class="admincls0" bgcolor="#FFFFFF">
            ...
            <tr style="height:30px">
                ...
                <td class="admincls0" bgcolor="#FFFFFF">
                    <span id="txtUnitPrice" name="txtUnitPrice" runat="server"></span>
                </td>
            </tr>
        </table>
    </div>
