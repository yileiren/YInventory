<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retrnToStorage_detail.aspx.cs" Inherits="YAgileASP.background.inventory.retrnToStorage.retrnToStorage_detail" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        function addDetail()
        {
            window.parent.popupsWindow("#popups", "选择货物", 800, 500, "inventory/retrnToStorage/chouseGoods.aspx?masterId=<%=this.inv.id %>" + "&warehouseId=" + <%=this.inv.warehouse.id %>, "icon-ok", true, true);
        }
        ...
        */
        function editDetail()
        {
            ...
            window.parent.popupsWindow("#popups", "修改明细", 600, 255, "inventory/retrnToStorage/retrnToStorage_detail_edit.aspx?masterId=" + $("#hidPutInStorageId").val() + "&id=" + $("input:checked[type='checkbox'][name='chkDetail']").eq(0).val(), "icon-edit", true, true);
        }
