<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="putInStorage_list.aspx.cs" Inherits="YAgileASP.background.inventory.putInStorage.putInStorage_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        * \brief
        * 新增入库单。
        * 作者：董帅 创建时间：2012-9-5 22:07:08
        */
        function addPutInStorage()
        {
            window.parent.popupsWindow("#popups", "新增入库单", 600, 165, "inventory/putInStorage/putInStorage_edit.aspx", "icon-add", true, true);
        }

        /*!
        * \brief
        * 修改入库单。
        * 作者：董帅 创建时间：2012-9-7 22:40:52
        */
        function editPutInStorage()
        {
            //判断选中
            if ($("input:checked[type='checkbox'][name='chkInv']").length != 1)
            {
                alert("请选中要编辑的入库单，一次只能选择一个！");
                return;
            }

            window.parent.popupsWindow("#popups", "修改入库单", 600, 165, "inventory/putInStorage/putInStorage_edit.aspx?id=" + $("input:checked[type='checkbox'][name='chkInv']").eq(0).val(), "icon-edit", true, true);
        }
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div region="north" border="true" style="height:28px;background-color:#EEF5FD">
        <div style="width:200px;margin-left:auto;margin-top:0px;margin-right:0px">
            <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:addPutInStorage();">新增</a>
            <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editPutInStorage();">修改</a>
            ...
            <div style="width:1120px;margin:0px auto">
                ...
                <ItemTemplate>
                    <tr style="width:100%;height:30px">
                        ...
                        <td class="admincls0" style="text-align:center">
                            <a href="putInStorage_detail.aspx?id=<%#Eval("id")%>" class="easyui-linkbutton" iconCls="icon-detail" plain="true" onclick="">明细</a>
                        </td>
                    </tr>
                </ItemTemplate>
