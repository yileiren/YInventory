...
{
    public partial class putInStorage_list : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (oper != null)
                {
                    ...
                    if (suppliers != null)
                    {
                        ...
                        this.selSupplier.DataSource = suppliers;
                        this.selSupplier.DataBind();
                        this.selSupplier.Items.Insert(0,new ListItem("全部","0"));
                    }
                    else
                    {
        ...
        public void bindInvs()
        {
            try
            {
                ...
                {
                    //获取入库单列表
                    List<InventoryMasterInfo> invs = invOper.getPutInStorage(this.txtNumber.Value,
            ...
            try
            {
                ...
                if (invIds.Length > 0)
                {
                    ...
                    if (oper != null)
                    {
                        ...
                        if (oper.deletePutInStorage(invIntIds))
                        {
                            this.Response.Redirect("putInStorage_list.aspx");
