<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="putInStorage_detail_edit.aspx.cs" Inherits="YAgileASP.background.inventory.putInStorage.putInStorage_detail_edit" %>
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD"">
        ...
        <input type="hidden" id="hidDetailId" name="hidDetailId" value="-1" runat="server" />
        <table class="admintable" style="width:100%;">
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">货物：</th>
                <td bgcolor="#FFFFFF">
                    <select id="selGoods" name="selGoods" runat="server" style="width:200px">
                    </select>
                </td>
            </tr>
            <tr style="height:30px">
               <th class="adminth_s2" style="width:120px;text-align:right">颜色：</th>
                <td bgcolor="#FFFFFF">
                    <select id="selColor" name="selColor" runat="server" style="width:200px">
                    </select>
                </td>
            </tr>
            <tr style="height:30px">
               <th class="adminth_s2" style="width:120px;text-align:right">尺码：</th>
                <td bgcolor="#FFFFFF">
                    <select id="selSize" name="selSize" runat="server" style="width:200px">
                    </select>
                </td>
            </tr>
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">数量：</th>
                <td bgcolor="#FFFFFF">
                    <input type="text" id="txtCount" name="txtCount" class="easyui-numberbox" required="true" min="1" max="50000" precision="0" value="0" runat="server" style="width:200px" />
                </td>
            </tr>
            <tr style="height:30px">
