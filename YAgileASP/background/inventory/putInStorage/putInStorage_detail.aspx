<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="putInStorage_detail.aspx.cs" Inherits="YAgileASP.background.inventory.putInStorage.putInStorage_detail" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        * \brief
        * 新增明细。
        * 作者：董帅 创建时间：2012-9-9 11:36:24
        */
        function addDetail()
        {
            window.parent.popupsWindow("#popups", "新增明细", 600, 225, "inventory/putInStorage/putInStorage_detail_edit.aspx?masterId=" + $("#hidPutInStorageId").val(), "icon-add", true, true);
        }

        /*!
        * \brief
        * 修改入库单明细。
        * 作者：董帅 创建时间：2012-9-11 22:06:51
        */
        function editDetail()
        {
            //判断选中
            ...
            {
                alert("请选中要编辑的入库单明细，一次只能选择一个！");
                return;
            }

            window.parent.popupsWindow("#popups", "修改明细", 600, 225, "inventory/putInStorage/putInStorage_detail_edit.aspx?masterId=" + $("#hidPutInStorageId").val() + "&id=" + $("input:checked[type='checkbox'][name='chkDetail']").eq(0).val(), "icon-edit", true, true);
        }
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div region="north" border="true" style="height:28px;background-color:#EEF5FD">
        <div style="width:250px;margin-left:auto;margin-top:0px;margin-right:0px">
            ...
            <a href="putInStorage_list.aspx" class="easyui-linkbutton" iconCls="icon-back" plain="true">返回</a>
        </div>
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD">
        <div style="width:1120px;margin:0px auto">
            ...
            <div class="easyui-panel" title="入库单明细" iconCls="icon-detail" style="width:1120px">
                <table class="admintable" style="width:100%">
                    <tr style="width:100%;height:30px">
                        ...
                        <th class="adminth" style="width:60px">数量</th>
