<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goods_edit.aspx.cs" Inherits="YAgileASP.background.inventory.goods.goods_edit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        * \brief
        * 验证表单。
        * 作者：董帅 创建时间：2012-9-2 16:22:54
        */
        function checkForms()
        {
            if (!$("#txtGoodsName").validatebox("isValid"))
            {
                return false;
            }
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD"">
        ...
        <table class="admintable" style="width:100%;">
            <tr style="height:30px">
                ...
                <td bgcolor="#FFFFFF"><input type="text" id="txtGoodsName" name="txtGoodsName" class="easyui-validatebox" required="true" maxlength="50" runat="server" style="width:200px" /></td>
            </tr>
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">货号：</th>
                <td bgcolor="#FFFFFF"><input type="text" id="txtGoodsNum" name="txtGoodsNum" class="easyui-validatebox" required="true" maxlength="50" runat="server" style="width:200px" /></td>
            </tr>
        </table>
    </div>
