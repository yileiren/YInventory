<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pushOutStorage_edit.aspx.cs" Inherits="YAgileASP.background.inventory.pushOutStorage.pushOutStorage_edit" %>
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD"">
        ...
        <table class="admintable" style="width:100%;">
            ...
            <tr style="height:30px">
               <th class="adminth_s2" style="width:120px;text-align:right">客户：</th>
                <td bgcolor="#FFFFFF">
