...
{
    public partial class pushOutStorage_list : System.Web.UI.Page
    {
        ...
        public void bindInvs()
        {
            try
            {
                ...
                {
                    //获取入库单列表
                    List<InventoryMasterInfo> invs = invOper.getPushOutStorage(this.txtNumber.Value,
            ...
            try
            {
                ...
                if (invIds.Length > 0)
                {
                    ...
                    if (oper != null)
                    {
                        ...
                        if (oper.deletePushOutStorage(invIntIds))
                        {
                            this.Response.Redirect("pushOutStorage_list.aspx");
