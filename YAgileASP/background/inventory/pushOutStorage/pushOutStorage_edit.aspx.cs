...
{
    public partial class pushOutStorage_edit : System.Web.UI.Page
    {
        ...
        protected void butSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    YMessageBox.show(this, "出库单编号不合法！");
                    return;
                }
                ...
                if (oper != null)
                {
                    if (string.IsNullOrEmpty(this.hidPutInStorageId.Value))
                    {
                        ...
                        {
                            YMessageBox.showAndResponseScript(this, "保存成功！", "window.parent.closePopupsWindow('#popups');", "window.parent.menuButtonOnClick('出库单','icon-pushOutStorage','inventory/pushOutStorage/pushOutStorage_list.aspx')");
                        }
                        else
                        {
