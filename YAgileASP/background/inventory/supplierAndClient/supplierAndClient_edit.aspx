<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supplierAndClient_edit.aspx.cs" Inherits="YAgileASP.background.inventory.supplierAndClient.supplierAndClient_edit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑客户和供应商</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        function checkForms()
        {
            if (!$("#txtSupplierAndClientName").validatebox("isValid"))
            {
                return false;
            }
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <div id="center" region="center" style="padding:3px;background-color:#EEF5FD"">
        <input type="hidden" id="hidSupplierAndClientId" name="hidDicId" runat="server" />
        <table class="admintable" style="width:100%;">
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">名称：</th>
                <td bgcolor="#FFFFFF"><input type="text" id="txtSupplierAndClientName" name="txtSupplierAndClientName" class="easyui-validatebox" required="true" maxlength="50" runat="server" style="width:200px" /></td>
            </tr>
            <tr style="height:30px">
                <th class="adminth_s2" style="width:120px;text-align:right">编号：</th>
                <td bgcolor="#FFFFFF"><input type="text" id="txtSupplierAndClientNum" name="txtSupplierAndClientNum" maxlength="50" runat="server" style="width:200px" /></td>
            </tr>
        </table>
    </div>
