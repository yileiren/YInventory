<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="retailStorage_list.aspx.cs" Inherits="YAgileASP.background.inventory.retailStorage.retailStorage_list" %>
...
<meta http-equiv="pragma" content="no-cache" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        */
        ...
        {
            window.parent.popupsWindow("#popups", "新增零售单", 600, 165, "inventory/retailStorage/retailStorage_edit.aspx", "icon-add", true, true);
        }
        ...
        */
        function editPushOutStorage()
        {
            ...
            {
                alert("请选中要编辑的零售单，一次只能选择一个！");
                return;
            }

            window.parent.popupsWindow("#popups", "修改零售单", 600, 165, "inventory/retailStorage/retailStorage_edit.aspx?id=" + $("input:checked[type='checkbox'][name='chkInv']").eq(0).val(), "icon-edit", true, true);
        }
            ...
            <div style="width:1120px;margin:0px auto">
                ...
                <ItemTemplate>
                    <tr style="width:100%;height:30px">
                        ...
                        <td class="admincls0" style="text-align:center">
                            <a href="retailStorage_detail.aspx?id=<%#Eval("id")%>" class="easyui-linkbutton" iconCls="icon-detail" plain="true" onclick="">明细</a>
                        </td>
                    </tr>
                </ItemTemplate>
