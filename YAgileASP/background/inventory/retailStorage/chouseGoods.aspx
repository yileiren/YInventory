<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chouseGoods.aspx.cs" Inherits="YAgileASP.background.inventory.retailStorage.chouseGoods" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        **/
        function chouseDetail()
        {
            ...
            //页面跳转
            window.parent.popupsWindow("#popups", "新增明细", 600, 255, "inventory/retailStorage/retailStorage_detail_edit.aspx?masterId=" + $("#hidMasterId").val() + "&chouseDetailId=" + $("input:checked[type='checkbox'][name='chkDetail']").eq(0).val(), "icon-add", true, true);
        }
    </script>
</head>
